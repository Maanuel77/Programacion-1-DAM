...
public class Principal {
	...
	public static void main(String[] args) {
		...
		System.out.println ("Comenzamos calculando la longitud del círculo, para ello introduce el radio de la misma, en caso de tener el diámetro simplemente divídalo por 2: ");
