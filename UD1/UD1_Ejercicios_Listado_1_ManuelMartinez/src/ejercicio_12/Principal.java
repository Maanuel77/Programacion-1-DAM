...
public class Principal {
	...
	public static void main(String[] args) {
		...
		String empleado, obj_1, obj_2, obj_3;
		...
		System.out.println ("\nTICKET DE COMPRA: \n\nLe atendió "+ empleado + "\n29/09/2025\n");
		System.out.println ("Nombre         Unidades         P/u         Subtotal\n*******************************************************************");
		System.out.printf ("%s         %d            %.2f €        %.2f €\n\n%s             %d            %.2f €        %.2f €\n\n%s             %d            %.2f €      %.2f €\n",obj_1, cant_1, prec_1, prec1_Subt, obj_2, cant_2, prec_2, prec2_Subt, obj_3, cant_3, prec_3, prec3_Subt);
		System.out.println("-------------------------------------------------------------------");
		System.out.printf("                                           | Total = %.2f €\n                                           | Entregado = %.2f €\n                                           | ----------------\n                                           | Devolución = %.2f €", prec_Total, dinero, devolución);
